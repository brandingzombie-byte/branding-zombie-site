...
// tells Gerry whether the lead maps to the Author Page or Author Catalog.
const STAGES = [
  "Still writing it",
  "Publishing with BookLogix now",
  "Published — one book",
...
export default function ConsultForm() {
  ...
  // BookLogix referrals are the warmest leads on the site — fire generate_lead
  // gated on leadId so the honeypot decoy (ok:true, no leadId) never counts.
  useEffect(() => {
    ...
    return (
      <div className="flex flex-col gap-6">
        <div className="flex items-end gap-4">
          ...
          <img
            src="/assets/booklogix/hand-thumbs-up.png"
            alt=""
            aria-hidden="true"
            width={160}
            height={90}
