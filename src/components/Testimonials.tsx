...
// possible. All 5★. Source: google.com/maps?cid=16008023750998412418
const testimonials = [
  {
    quote:
      "Branding Zombie Designs redid our terrible website in a very short time. Gerry &ldquo;got it&rdquo; immediately, took pictures during our first brief meeting and even grabbed pics from Facebook so we&rsquo;d have basic stuff up without sending it. He&rsquo;s a can-do person — and a super nice guy, too.",
    name: "Sandra Allen",
  ...
  {
    quote:
      "Gerry and I, after a brief conversation, came up with a plan to do some flyer and graphic design for my gym. A few days later he provided me with the most valuable asset I needed to save time in my business. Work with Gerry. It&rsquo;s a fantastic decision.",
    name: "Mitch Marks",
    business: "Gym owner",
  ...
  {
    quote:
      "Def recommend for marketing, designs, branding, websites, printing. He knows his stuff and his turnover time is hella fast. The quality and attention to detail is chef&rsquo;s kiss. His approach isn&rsquo;t boring — it&rsquo;s modern, it&rsquo;s new. I mean, come on. ZOMBIES. It&rsquo;s a whole vibe.",
    name: "Mary Jeimz",
