...
// Shared CTA row for location pages — primary books the free consult, secondary
// is click-to-call (the action most local mobile visitors actually take).
    ...
    <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center">
      <a
        ...
        className={cn(
          ...
          large
            ? "px-9 py-4 text-[length:var(--text-body)]"
            : "px-7 py-3.5 text-sm",
        )}
      >
        {primaryLabel}
      ...
      <a
        ...
        className={cn(
          ...
          large
            ? "px-7 py-3.5 text-[length:var(--text-secondary)]"
            : "px-6 py-3 text-sm",
        )}
      >
