// JSON-LD for the /tattoo-shop-marketing page (pillar + per-city). Emits:
...
//  3. BreadcrumbList — Home → Tattoo Shop Marketing (→ City).
...
import type { TattooProduct, TattooFaq } from "@/data/tattoo-marketing";
import type { Location } from "@/data/locations";

export default function TattooJsonLd({
  product,
  city,
  cityFaq,
}: {
  ...
  const serviceSchema = {
    ...
    audience: {
      ...
      audienceType: city
        ? `Tattoo shops in ${city.city}, ${city.county} and North Metro Atlanta`
        : "Tattoo shops in Cumming, Forsyth County and North Metro Atlanta",
    },
    hasOfferCatalog: {
      "@type": "OfferCatalog",
    ...
    offers: {
      "@type": "Offer",
      priceCurrency: "USD",
      description: `${product.label} — flat pricing, from $1,500`,
