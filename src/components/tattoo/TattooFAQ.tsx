...
import type { TattooFaq } from "@/data/tattoo-marketing";

// Client component so the base-ui Accordion (which uses React context) lives
// inside a client boundary — mirrors the proven WindowClingsFAQ pattern.
export default function TattooFAQ({ faqs }: { faqs: TattooFaq[] }) {
  return (
      ...
      <Reveal className="lg:col-span-4">
        <div className="lg:sticky lg:top-28">
          <span className="text-[length:var(--text-caption)] font-semibold uppercase tracking-[0.2em] text-[var(--color-cyan-text)]">
            What tattoo shop owners ask us
          </span>
