...
import type { WCFaq } from "@/data/window-clings";

// Client component so the base-ui Accordion (which uses React context) lives
// inside a client boundary — mirrors the proven ServiceFAQ / MailerFAQ pattern.
export default function WindowClingsFAQ({ faqs }: { faqs: WCFaq[] }) {
  return (
