...
export default function WindowClingsHero({
  eyebrow,
  headline,
  highlight,
  subhead,
        ...
        <div className="flex flex-col">
          ...
          <motion.div {...rise(24, 0.32)} className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <a
              ...
              onClick={() => trackEvent("contact_intent", { method: "calendly", source: "window_clings_hero" })}
          ...
          <motion.div {...rise(16, 0.44)} className="mt-6 flex flex-wrap items-center gap-x-5 gap-y-2">
            ...
            <a
              href={phoneHref}
              onClick={() => trackEvent("contact_intent", { method: "phone", source: "window_clings_hero" })}
